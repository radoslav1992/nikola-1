...
export const T = {
  bg: {
    ...
    footerSource: 'Имотите в този каталог са подбрани и се поддържат лично от Никола Иванов.', footerUpdated: 'Обновено',
  ...
  en: {
    ...
    footerSource: 'Properties in this catalogue are selected and maintained personally by Nikola Ivanov.', footerUpdated: 'Updated',
